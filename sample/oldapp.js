...
function convertDocx(source, dest,docx) {
    ...
    docXML = docXML.replace(/=\"Win Innwa\"/g, "=\"Myanmar Text\"")
    let content = winToMyanmar3(docXML);
...
function convertXlsx(source, dest,xlsx) {
    ...
    content = docXML.replace(/val\=\"Win Innwa\"/g, "val\=\"Myanmar Text\"")
...
function convertPptx(source, dest,xlsx) {
    ...
    filenames.forEach(file => { 
        ...
        if (extension == ".xml") {
            ...
            let content = winToMyanmar3(docXML);
            content = content.replace(/\stypeface\=\"Win Innwa\"\s/g, " typeface=\"Myanmar Text\" ")
                    ...
                    if (dirent.isDirectory()) {
                        ...
                        if (extension == ".docx") {
                            ...
                            if (!isText(res)) {
                                ...
                                let content = winToMyanmar3(zawgyi);
